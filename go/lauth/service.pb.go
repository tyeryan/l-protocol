...
func (x *AuthReq) Reset() {
	*x = AuthReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lauth_service_proto_msgTypes[0]
...
func (*AuthReq) Descriptor() ([]byte, []int) {
	return file_lauth_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AuthRsp) Reset() {
	*x = AuthRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lauth_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthRsp) Descriptor() ([]byte, []int) {
	return file_lauth_service_proto_rawDescGZIP(), []int{1}
}
...
var File_lauth_service_proto protoreflect.FileDescriptor

var file_lauth_service_proto_rawDesc = []byte{
	0x0a, 0x13, 0x6c, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6c, 0x61, 0x75, 0x74, 0x68, 0x22, 0x41, 0x0a, 0x07,
...
var (
	file_lauth_service_proto_rawDescOnce sync.Once
	file_lauth_service_proto_rawDescData = file_lauth_service_proto_rawDesc
)

func file_lauth_service_proto_rawDescGZIP() []byte {
	file_lauth_service_proto_rawDescOnce.Do(func() {
		file_lauth_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_lauth_service_proto_rawDescData)
	})
	return file_lauth_service_proto_rawDescData
}

var file_lauth_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_lauth_service_proto_goTypes = []interface{}{
	(*AuthReq)(nil), // 0: lauth.AuthReq
...
func init() { file_lauth_service_proto_init() }
func file_lauth_service_proto_init() {
	if File_lauth_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lauth_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lauth_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lauth_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_lauth_service_proto_goTypes,
		DependencyIndexes: file_lauth_service_proto_depIdxs,
		MessageInfos:      file_lauth_service_proto_msgTypes,
	}.Build()
	File_lauth_service_proto = out.File
	file_lauth_service_proto_rawDesc = nil
	file_lauth_service_proto_goTypes = nil
	file_lauth_service_proto_depIdxs = nil
}
